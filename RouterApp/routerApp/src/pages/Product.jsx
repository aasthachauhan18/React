              ...
              <div className="col p-4 d-flex flex-column position-static">
                ...
                >
                  ...
                  <svg className="bi" aria-hidden="true">
                    <use xlink:to="#chevron-right"></use>
                  </svg>{" "}
                </Link>{" "}
              </div>{" "}
        ...
        <div className="row g-5">
          ...
          <div className="col-md-8">
            ...
            <article className="blog-post">
              ...
              <p className="blog-post-meta">
                December 23, 2020 by <Link to="#">Jacob</Link>
              </p>{" "}
              <p>
                This is some additional paragraph placeholder content. It has
                been written to fill the available space and show how a longer
              ...
              <table className="table">
                ...
                <thead>
                  ...
                  <tr>
                    {" "}
                    <th>Name</th> <th>Upvotes</th> <th>Downvotes</th>{" "}
                  </tr>{" "}
                </thead>{" "}
                <tbody>
                  {" "}
                  <tr>
                    {" "}
                    <td>Alice</td> <td>10</td> <td>11</td>{" "}
                  </tr>{" "}
                  <tr>
                    {" "}
                    <td>Bob</td> <td>4</td> <td>3</td>{" "}
                  </tr>{" "}
                  <tr>
                    {" "}
                    <td>Charlie</td> <td>7</td> <td>9</td>{" "}
                  </tr>{" "}
                </tbody>{" "}
                <tfoot>
                  {" "}
                  <tr>
                    {" "}
                    <td>Totals</td> <td>21</td> <td>23</td>{" "}
                  </tr>{" "}
                </tfoot>{" "}
              </table>{" "}
              <p>
            ...
            <article className="blog-post">
              ...
              <p className="blog-post-meta">
                December 14, 2020 by <Link to="#">Chris</Link>
              </p>{" "}
              <p>
                This is some additional paragraph placeholder content. It has
                been written to fill the available space and show how a longer
